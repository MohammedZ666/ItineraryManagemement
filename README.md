...
## NPM
NPM can be used to setup the project, for this please ensure Node.js with version 18.13.0 is installed. For windows download a `.msi` file from [here](https://nodejs.org/dist/v18.13.0/) according to your architechture and install. For linux based distributions, follow the instructions provided [here](https://github.com/nodesource/distributions#installation-instructions).
